<?php $__env->startSection('frontend-designer-html-content'); ?>
...
<div id="product_designer" class="container new-container">
  ...
  <div class="row">
    <div class="col-sm-12">
      <?php echo $__env->make('pages.common.designer-html', array('designer_hf_data' => $designer_hf_data, 'designer_img_elments' => $single_product_details['_product_custom_designer_data'], 'design_save_data' => $design_json_data), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div>
  </div>
  <br>
  <div class="row">
