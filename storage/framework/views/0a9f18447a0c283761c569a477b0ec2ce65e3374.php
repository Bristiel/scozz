<?php $__env->startSection('user-update-content'); ?>
...
<form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
  ...
  <div class="box box-solid">
    <div class="box-header">
      <h3 class="box-title"><?php echo e(trans('admin.update_new_user_title')); ?> &nbsp;&nbsp;&nbsp;&nbsp;<a class="btn btn-default btn-xs" href="<?php echo e(route('admin.users_list')); ?>"><?php echo e(trans('admin.user_list_title')); ?></a></h3>
